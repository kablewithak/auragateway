...
SOURCE_MAIN_COMMIT: Final = "4244db789afdf3a542fad11a5581a07c69c3dd3f"
IMPLEMENTATION_MERGE_COMMIT: Final = "6e424acb27e568bb7ce5000ea0732e175bf6b35a"
SAVED_VERSION_ID: Final = 340962890
...
EVIDENCE_ZIP_SHA256: Final = "fead0bbdcb7cbe62ef9c5df8467cd818152b05d259c3f656f2d4d7217b2d996f"
EVIDENCE_ZIP_SIZE_BYTES: Final = 22662
TERMINAL_LOG_SHA256: Final = "4eb48005682a5743094c466b29d3f6494c83d02909d62aa923c3bbca17781db3"
TERMINAL_LOG_SIZE_BYTES: Final = 3560

SOURCE_PATH: Final = Path(
    "src/auragateway/local_abc/p5_p6_successor_unauthorized_execution_reconciliation_v2.py"
)
TEST_PATH: Final = Path(
    "tests/unit/local_abc/test_p5_p6_successor_unauthorized_execution_reconciliation_v2.py"
)
ADR_PATH: Final = Path(
    "docs/adr/2026-08-08-local-abc-p5-p6-successor-unauthorized-execution-reconciliation-v2.md"
)
REPORT_PATH: Final = Path(
    "docs/reports/AuraGateway_P5_P6_Successor_Unauthorized_Execution_Reconciliation_V2.md"
)
RUNBOOK_PATH: Final = Path(
    "docs/runbooks/local_abc_p5_p6_successor_unauthorized_execution_reconciliation_v2.md"
)
REVIEW_PATH: Final = Path(
    "benchmarks/local_abc/"
    "auragateway_p5_p6_successor_unauthorized_execution_reconciliation_v2_review.json"
)
RECORD_PATH: Final = Path(
    "benchmarks/local_abc/"
    "auragateway_p5_p6_successor_unauthorized_execution_reconciliation_v2_record.json"
)
...
EXPECTED_EVIDENCE_MEMBERS: Final = (
    ...
    (
        ...
        "926b00cac09bd6e59c17b8f778b9860d1f3c5a4608ae0d665e4536b235f08108",
        20636,
    ),
    (
    ...
    (
        ...
        "a2375b98c4433b2408a035deed7752e04b94a6197074d29d4ce1aff884d1b543",
        4734,
    ),
    (
        "p3_worker_startup_report_v1.json",
        "5580b78dc72d7f6c402d2452c51dd467a30a53393d1091b882242c8ef69b33de",
        6554,
    ),
    (
        "p3_native_origin_report_v1.json",
        "5832118bd5abc45cb1e2dca35df4718bf2964f8756434903fa62cd4ccb5d1720",
        12248,
    ),
    (
        "p4_case_a_canary_report_v1.json",
        "12e9413b9f685b41f47a953b6041141f73b926115dfd01a9d863e8d9f66517bd",
        1070,
    ),
    (
        "p5_prefix_cache_reset_report_v1.json",
        "2b269e07c4fec61832c8b69c3f76e75d7797330f2e46555b7b5e5a846bae3133",
        2818,
    ),
    (
        "p5_post_restart_native_origin_report_v1.json",
        "639f6acf3e23104b45a281fec0046e59cf855b04868c8edf2a46f4a21766a27f",
        10617,
    ),
    (
        "p6_stage_checkpoint_report_v1.json",
        "4df99ed93c0df1f170b07401329c48f58b51be4c6e278d88fb313743fe07aeaa",
        3462,
    ),
    (
        "p6_native_origin_report_v1.json",
        "d9117a49318ef183abe22874a68b6fca02b6b53d323cf7510ea7fe5c217ae632",
        20771,
    ),
    (
        "p6_dual_worker_isolation_report_v1.json",
        "f27b7454a17aaa921a31274fbf39b6e87d3ff29d3b73e4e368e010c95a442c8b",
        25781,
    ),
    (
        "worker_teardown_report_v1.json",
        "5aae1c76ddbd39780e785ce6635771510212fb80ddaecaa04aed9a05b1261739",
        2248,
    ),
    (
    ...
    (
        ...
        "1f2b2048faae86b828c411b6d77e23d702e555ef30d4f42e592446c236f6208a",
        2620,
    ),
...
class TechnicalEvidence(LocalABCContract):
    ...
    saved_version_id: Literal[340962890]
    ...
    evidence_zip_sha256: Literal["fead0bbdcb7cbe62ef9c5df8467cd818152b05d259c3f656f2d4d7217b2d996f"]
    evidence_zip_size_bytes: Literal[22662]
    terminal_log_sha256: Literal["4eb48005682a5743094c466b29d3f6494c83d02909d62aa923c3bbca17781db3"]
    terminal_log_size_bytes: Literal[3560]
...
class ReconciliationReview(LocalABCContract):
    ...
    review_id: Literal[
        "auragateway-p5-p6-successor-unauthorized-execution-reconciliation-v2-review"
    ]
    ...
    source_main_commit: Literal["4244db789afdf3a542fad11a5581a07c69c3dd3f"]
...
class ReconciliationRecord(LocalABCContract):
    ...
    schema_version: Literal["1.0.0"] = "1.0.0"
    record_id: Literal[
        "auragateway-p5-p6-successor-unauthorized-execution-reconciliation-v2-record"
    ]
    status: Literal["P5_P6_SUCCESSOR_UNAUTHORIZED_EXECUTION_RECONCILIATION_V2_VALID"]
    source_main_commit: Literal["4244db789afdf3a542fad11a5581a07c69c3dd3f"]
    technical_evidence: TechnicalEvidence
    governance: GovernanceDisposition
...
def _review(repo_root: Path) -> ReconciliationReview:
    ...
    return ReconciliationReview(
        review_id=("auragateway-p5-p6-successor-unauthorized-execution-reconciliation-v2-review"),
        ...
        non_claims=(
            ...
            "Saved version 340962890 is not authorized for replay.",
...
def _record(repo_root: Path, review: ReconciliationReview) -> ReconciliationRecord:
    return ReconciliationRecord(
        record_id=("auragateway-p5-p6-successor-unauthorized-execution-reconciliation-v2-record"),
        status="P5_P6_SUCCESSOR_UNAUTHORIZED_EXECUTION_RECONCILIATION_V2_VALID",
        source_main_commit=SOURCE_MAIN_COMMIT,
        technical_evidence=_technical_evidence(),
        governance=_governance(),
        review=ArtifactReceipt(
