...
from auragateway.local_abc import (
    full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v2,
)
from auragateway.local_abc.contracts import LocalABCContract

implementation = full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v2

SOURCE_MAIN_MERGE_COMMIT: Final = "87f2d4e08043c0c6ec5dee93d14c0523f531e8fe"
...
IMPLEMENTATION_REQUEST_SHA256: Final = (
    "90c6c6bdee535101060af2baccbea19886a22532de606c828958f4f215fc3446"
)
IMPLEMENTATION_REVIEW_SHA256: Final = (
    "a948216e6760092c30faec3db4e82c6a2731ac7f77a45a03adb32c0a11cae4bc"
)
IMPLEMENTATION_TEMPLATE_SHA256: Final = (
    "d0be85cd39dd11cd35fd9fa0ec36520fb7e7605cdbbb63f6a6dbfd4dfea732d2"
)
IMPLEMENTATION_SOURCE_SHA256: Final = (
    "54b03130bef929dff6d977bed07e69250672d31f1cb1cb6901b7921316eb6fff"
)
...
ISSUER_SOURCE_PATH: Final = Path(
    "src/auragateway/local_abc/"
    "full_abc_local_environment_qualification_cu129_"
    "p3_p6_runtime_diagnostic_execution_authorization_v2.py"
)
...
ADR_PATH: Final = Path(
    "docs/adr/2026-08-01-local-abc-cu129-p3-p6-runtime-diagnostic-execution-authorization-v2.md"
)
REPORT_PATH: Final = Path(
    "docs/reports/AuraGateway_CU129_P3_P6_Runtime_Diagnostic_Execution_Authorization_V2.md"
)
RUNBOOK_PATH: Final = Path(
    "docs/runbooks/local_abc_cu129_p3_p6_runtime_diagnostic_execution_authorization_v2.md"
)
REVIEW_PATH: Final = Path(
    "benchmarks/local_abc/auragateway_cu129_p3_p6_runtime_diagnostic_"
    "execution_authorization_v2_review.json"
)
RECORD_PATH: Final = Path(
    "benchmarks/local_abc/auragateway_cu129_p3_p6_runtime_diagnostic_"
    "execution_authorization_v2_record.json"
)
...
AUTHORIZATION_SCOPE: Final = "P3_P6_RUNTIME_DIAGNOSTIC_V2"
SELECTED_BACKEND: Final = "TRITON_ATTN"
MAXIMUM_AUTHORIZATION_WINDOW_MINUTES: Final = 240
IMPLEMENTATION_NEXT_GATE: Final = (
    "explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v2"
)
ISSUED_NEXT_GATE: Final = "execute_governed_p3_p6_runtime_diagnostic_v2"
CONSUMED_NEXT_GATE: Final = "preserve_and_accept_p3_p6_runtime_diagnostic_evidence_v2"
...
class ImplementationAuthority(LocalABCContract):
    ...
    source_main_merge_commit: Literal["87f2d4e08043c0c6ec5dee93d14c0523f531e8fe"]
    implementation_feature_commit: Literal["d6837f057790279727fbb71177a615a0a12928ef"]
    ...
    unchanged_v1_failure_replay_authorized: Literal[False]
...
class AuthorizationArchitectureReview(LocalABCContract):
    ...
    review_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v2-review"
    ]
    status: Literal["APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION"]
    decision: Literal["SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_V2_AUTHORIZATION"]
    ...
    next_gate: Literal["explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v2"]
...
class AuthorizationImplementationRecord(LocalABCContract):
    ...
    schema_version: Literal["1.0.0"] = "1.0.0"
    record_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v2-record"
    ]
    status: Literal["P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V2_VALID"]
...
class AuthorizationIssuanceConfirmation(LocalABCContract):
    ...
    confirmed_scope: Literal["P3_P6_RUNTIME_DIAGNOSTIC_V2"]
...
class P3P6ExecutionAuthorization(LocalABCContract):
    ...
    request_sha256: Literal["90c6c6bdee535101060af2baccbea19886a22532de606c828958f4f215fc3446"]
...
def _implementation_authority(repo_root: Path) -> ImplementationAuthority:
    ...
    if record.get("authorization_issuer_included") is not False:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_IMPLEMENTATION_STATE_INVALID",
            "the V2 implementation unexpectedly includes an authorization issuer",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )
    if request.get("authorization_issuer_included") is not False:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_REQUEST_STATE_INVALID",
            "the V2 request unexpectedly includes an authorization issuer",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    if record.get("next_gate") != ("merge_then_design_separate_p3_p6_execution_authorization_v2"):
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_IMPLEMENTATION_GATE_DRIFT",
            "the merged V2 implementation next gate drifted",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )
    known_failure = request.get("known_v1_failure")
    if not isinstance(known_failure, dict):
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_V1_FAILURE_CONTEXT_INVALID",
            "the V2 request lacks the accepted V1 failure context",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    if known_failure.get("runtime_root_cause_confirmed") is not False:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_ROOT_CAUSE_CLAIM_DRIFT",
            "the V2 request overclaims the historical runtime root cause",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    install_diagnostics = request.get("install_diagnostics")
    if not isinstance(install_diagnostics, dict):
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_INSTALL_DIAGNOSTICS_INVALID",
            "the V2 request lacks installation diagnostics",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    if install_diagnostics.get("find_links_relative_path") != "wheels":
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_FIND_LINKS_SCOPE_DRIFT",
            "the V2 wheel discovery scope drifted",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    return ImplementationAuthority(
        ...
        unchanged_v1_failure_replay_authorized=False,
    )


def _build_review(repo_root: Path) -> AuthorizationArchitectureReview:
    return AuthorizationArchitectureReview(
        review_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v2-review"),
        status="APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION",
        decision="SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_V2_AUTHORIZATION",
        ...
        non_claims=(
            ...
            "The V1 pip root cause remains historically unresolved.",
            "The V2 installation telemetry has not yet been observed on Kaggle.",
...
def _build_record(
    ...
    return AuthorizationImplementationRecord(
        record_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v2-record"),
        status="P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V2_VALID",
        source_main_merge_commit=SOURCE_MAIN_MERGE_COMMIT,
        implementation=_implementation_authority(repo_root),
        review=ArtifactReceipt(
...
def _build_parser() -> argparse.ArgumentParser:
    parser = _ArgumentParser(prog="auragateway-p3-p6-authorization-v2")
