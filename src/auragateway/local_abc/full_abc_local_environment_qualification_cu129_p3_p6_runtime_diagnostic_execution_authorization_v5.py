...
from auragateway.local_abc import (
    full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v5,
)
from auragateway.local_abc.contracts import LocalABCContract

implementation = full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v5

SOURCE_MAIN_MERGE_COMMIT: Final = "13861da2f13f2ce55fd5fa935e38c765602cb374"
IMPLEMENTATION_FEATURE_COMMIT: Final = "a942c1edb46ae98a0db9ac9e7085d7a648372d1c"
...
IMPLEMENTATION_REVIEW_SHA256: Final = (
    "eea32bdadfc31d6242c0bd7ee9119cfec6853754776f77eef02ae4871f968234"
)
...
IMPLEMENTATION_SOURCE_SHA256: Final = (
    "7428040b26b11dc76a8394f5c9a2dc1e1d1f2a44d4d6f7982e1b9cddfb6f7092"
)
...
ISSUER_SOURCE_PATH: Final = Path(
    "src/auragateway/local_abc/"
    "full_abc_local_environment_qualification_cu129_"
    "p3_p6_runtime_diagnostic_execution_authorization_v5.py"
)
...
ADR_PATH: Final = Path(
    "docs/adr/2026-08-04-local-abc-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5.md"
)
REPORT_PATH: Final = Path(
    "docs/reports/AuraGateway_CU129_P3_P6_Runtime_Diagnostic_Execution_Authorization_V5.md"
)
RUNBOOK_PATH: Final = Path(
    "docs/runbooks/local_abc_cu129_p3_p6_runtime_diagnostic_execution_authorization_v5.md"
)
REVIEW_PATH: Final = Path(
    "benchmarks/local_abc/auragateway_cu129_p3_p6_runtime_diagnostic_"
    "execution_authorization_v5_review.json"
)
RECORD_PATH: Final = Path(
    "benchmarks/local_abc/auragateway_cu129_p3_p6_runtime_diagnostic_"
    "execution_authorization_v5_record.json"
)
...
AUTHORIZATION_ID: Final = "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5"
AUTHORIZATION_SCOPE: Final = "P3_P6_RUNTIME_DIAGNOSTIC_V5"
SELECTED_BACKEND: Final = "TRITON_ATTN"
MAXIMUM_AUTHORIZATION_WINDOW_MINUTES: Final = 240
IMPLEMENTATION_NEXT_GATE: Final = (
    "explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v5"
)
ISSUED_NEXT_GATE: Final = "execute_governed_p3_p6_runtime_diagnostic_v5"
CONSUMED_NEXT_GATE: Final = "preserve_and_accept_p3_p6_runtime_diagnostic_evidence_v5"
...
class EvidenceContractAuthority(LocalABCContract):
    """Exact V5 runtime evidence contract authorized for one attempt."""
...
class ImplementationAuthority(LocalABCContract):
    ...
    source_main_merge_commit: Literal["13861da2f13f2ce55fd5fa935e38c765602cb374"]
    implementation_feature_commit: Literal["a942c1edb46ae98a0db9ac9e7085d7a648372d1c"]
    ...
    wrapper_code_sha256: Literal["55ac4828fcc8a2a18bb60a939416f93f4c0b2d4f36d386ec009079ca6c4babb8"]
    ...
    unchanged_v4_failure_replay_authorized: Literal[False]
...
class AuthorizationControls(LocalABCContract):
    ...
    model_semantics_permitted_as_p6_route_proof: Literal[False] = False
    precise_p6_failure_taxonomy_required: Literal[True] = True
    runtime_native_origin_report_required: Literal[True] = True
    cuda_stub_origin_permitted: Literal[False] = False
...
class AuthorizationArchitectureReview(LocalABCContract):
    ...
    review_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5-review"
    ]
    status: Literal["APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION"]
    decision: Literal["SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_V5_AUTHORIZATION"]
    ...
    next_gate: Literal["explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v5"]
...
class AuthorizationImplementationRecord(LocalABCContract):
    ...
    schema_version: Literal["1.0.0"] = "1.0.0"
    record_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5-record"
    ]
    status: Literal["P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V5_VALID"]
...
class AuthorizationIssuanceConfirmation(LocalABCContract):
    ...
    confirmed_scope: Literal["P3_P6_RUNTIME_DIAGNOSTIC_V5"]
...
class P3P6ExecutionAuthorization(LocalABCContract):
    ...
    request_sha256: Literal["b9eb7e968e79df97c4892f1dc6b19a245ac8fe61764c5dd9ecc6076ec7e32e5b"]
    notebook_sha256: Literal["2f96ca44a6eb1fb7163d62ee9555544a821fa4700d93966ed1c2d3a478fe4bef"]
    runtime_script_sha256: Literal[
        "44ff2b6ec032c49b1b38dab3b0c919134f70345b5fe29f7359fcd7842759b996"
    ]
    wrapper_code_sha256: Literal["55ac4828fcc8a2a18bb60a939416f93f4c0b2d4f36d386ec009079ca6c4babb8"]
...
class P3P6AuthorizationConsumption(LocalABCContract):
    ...
    next_gate: Literal["preserve_and_accept_p3_p6_runtime_diagnostic_evidence_v5"]
...
def _implementation_authority(repo_root: Path) -> ImplementationAuthority:
    ...
    if record.get("authorization_issuer_included") is not False:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_IMPLEMENTATION_STATE_INVALID",
            "the V5 implementation unexpectedly includes an authorization issuer",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )
    if request.get("authorization_issuer_included") is not False:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_REQUEST_STATE_INVALID",
            "the V5 request unexpectedly includes an authorization issuer",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    if record.get("next_gate") != ("merge_then_design_separate_p3_p6_execution_authorization_v5"):
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_IMPLEMENTATION_GATE_DRIFT",
            "the merged V5 implementation next gate drifted",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )

    known_failure = request.get("known_v4_failure")
    expected_failure = {
        ...
        "p6_complete_isolation_established": False,
        "reported_failure_code": "P3_P6_DUAL_WORKER_ISOLATION_FAILED",
        "saved_version_id": 340120168,
        "unchanged_replay_authorized": False,
        "worker_1_route_transport_completed": True,
        "worker_2_route_attempted": False,
    }
    if known_failure != expected_failure:
        raise P3P6AuthorizationError(
            "P3_P6_AUTHORIZATION_V4_FAILURE_CONTEXT_DRIFT",
            "the accepted V4 failure context drifted",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    ...
    if evidence_contract != expected_evidence_contract:
        raise P3P6AuthorizationError(
            ...
            "the V5 evidence contract drifted",
            IMPLEMENTATION_REQUEST_PATH.as_posix(),
        )
    ...
    if not isinstance(record_notebook, dict):
        raise P3P6AuthorizationError(
            ...
            "the V5 notebook receipt is unavailable",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )
    if (
        ...
        raise P3P6AuthorizationError(
            ...
            "the V5 runtime-script or wrapper identity drifted",
            IMPLEMENTATION_RECORD_PATH.as_posix(),
        )
    ...
    return ImplementationAuthority(
        ...
        unchanged_v4_failure_replay_authorized=False,
    )


def _build_review(repo_root: Path) -> AuthorizationArchitectureReview:
    return AuthorizationArchitectureReview(
        review_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5-review"),
        status="APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION",
        decision="SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_V5_AUTHORIZATION",
        ...
        non_claims=(
            ...
            "The V5 P3-P6 notebook has not been executed.",
            "No Kaggle session or GPU action has been started.",
            "No target runtime has been installed by this authorization tranche.",
            "The accepted V4 failed lifecycle remains consumed and non-replayable.",
            "The V5 evidence-contract implementation is repository validated only.",
            "No model has been loaded.",
            "No worker has been started.",
            "No model request has been issued.",
            "No cache behavior or reset has been observed for V5.",
            "No dual-worker isolation has been observed for V5.",
            "No native-origin closure has been observed for V5.",
...
def _build_record(
    ...
    return AuthorizationImplementationRecord(
        record_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v5-record"),
        status="P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V5_VALID",
        source_main_merge_commit=SOURCE_MAIN_MERGE_COMMIT,
        implementation=_implementation_authority(repo_root),
        review=ArtifactReceipt(
    ...
    *,
    ...
    if not all(confirmation_checks):
        raise P3P6AuthorizationError(
            ...
            "operator confirmation does not bind the reviewed V5 identities",
        )
...
def _build_parser() -> argparse.ArgumentParser:
    parser = _ArgumentParser(prog="auragateway-p3-p6-authorization-v5")
        ...
        if arguments.command == "generate":
            ...
            confirmation = AuthorizationIssuanceConfirmation(
                confirmation_id=(
                    ...
                    "execution-authorization-confirmation-v5"
                ),
