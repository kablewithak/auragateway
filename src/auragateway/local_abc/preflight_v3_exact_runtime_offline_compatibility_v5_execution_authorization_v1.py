"""Single-use execution authorization for Final Offline Verifier V5."""
...
IMPLEMENTATION_FEATURE_COMMIT: Final = "7760ee785ec11d6c85d8d2d2d2a20b59a2ef9e23"
IMPLEMENTATION_MERGE_COMMIT: Final = "a0a21c648e881c7eb733967b42ee6f08cbcbb48a"

V5_VALIDATOR_MODULE: Final = (
    "auragateway.local_abc.preflight_v3_exact_runtime_offline_compatibility_v5"
)

ISSUER_SOURCE_PATH: Final = Path(
    "src/auragateway/local_abc/"
    "preflight_v3_exact_runtime_offline_compatibility_v5_"
    "execution_authorization_v1.py"
)
ISSUER_TEST_PATH: Final = Path(
    "tests/unit/local_abc/"
    "test_preflight_v3_exact_runtime_offline_compatibility_v5_"
    "execution_authorization_v1.py"
)
ISSUER_RUNBOOK_PATH: Final = Path(
    "docs/runbooks/local_abc_preflight_v3_final_offline_verifier_v5_execution_authorization_v1.md"
)
...
V5_ARTIFACT_IDENTITIES: Final[dict[str, tuple[str, int]]] = {
    ("notebooks/auragateway_preflight_v3_exact_runtime_offline_compatibility_v5.ipynb"): (
        "76fcefea77505180aca1fdfd89179a1a81c49fd754507aacd17277caf012f2ea",
        149490,
    ),
    ("src/auragateway/local_abc/preflight_v3_exact_runtime_offline_compatibility_v5.py"): (
        "beb3a4283dada4291863e1c9c9c5c3c398f39cc0952a89c0bc6044290cdb9dce",
        37258,
    ),
    ("tests/unit/local_abc/test_preflight_v3_exact_runtime_offline_compatibility_v5.py"): (
        "58518262c64a7f0388dc08c66c2fbd9045d0ff5ceae509b997fbcad823361922",
        17448,
    ),
    (
        "docs/adr/"
        "2026-08-09-local-abc-final-offline-verifier-v5-"
        "semantic-boundary-implementation.md"
    ): (
        "b0b59baacb40c85cfdc4e42ba563eef9f19fd216c2e614032c40ea11435fc110",
        3927,
    ),
    ("docs/reports/AuraGateway_Preflight_V5_Final_Offline_Verifier_Implementation_V1.md"): (
        "e2bb72d8330c6be2ffd5212773430a2c2223f75c1795afc831954a83e516d69b",
        2565,
    ),
    ("docs/runbooks/local_abc_preflight_v3_final_exact_runtime_offline_verifier_v5.md"): (
        "3870374721ec837fc763a6b65eff30741abeb17d19354cae070e0b1d248e5f09",
        2010,
    ),
    (
        "benchmarks/local_abc/"
        ...
        "f6f81f90b69d1aaeebff015f2c22444b48ef85092d71707190c256a9318f6715",
        4683,
    ),
    (
        "benchmarks/local_abc/"
        ...
        "3f3e1b67429c2ddc9f694e554a9ed6ce23f060c3304f6392b80cd94450762518",
        2181,
    ),
}

AUTHORIZATION_ID: Final = (
    "auragateway-preflight-v3-exact-runtime-offline-compatibility-v5-execution-authorization-v1"
)
...
CONFIRMATION_PHRASE: Final = (
    ...
    "FINAL_OFFLINE_VERIFIER_V5_EXECUTION"
)
...
NEXT_GATE_AFTER_ISSUE: Final = "execute_one_governed_final_offline_verifier_v5_saved_version"
NEXT_GATE_AFTER_CONSUMPTION: Final = (
    "preserve_and_accept_or_classify_final_offline_verifier_v5_evidence"
)
NEXT_GATE_AFTER_ABANDONMENT: Final = (
    "reconcile_then_issue_fresh_final_offline_verifier_v5_authorization"
)
...
class IssuerRecord(FrozenModel):
    """Deterministic repository receipt for the V5 authorization issuer."""

    schema_version: Literal["1.0.0"] = "1.0.0"
    record_id: Literal[
        "auragateway-preflight-v3-final-offline-verifier-v5-execution-authorization-issuer-v1"
    ]
    status: Literal["FINAL_OFFLINE_VERIFIER_V5_EXECUTION_AUTHORIZATION_ISSUER_VALID"]
    bound_implementation_feature_commit: Literal["7760ee785ec11d6c85d8d2d2d2a20b59a2ef9e23"]
    bound_implementation_merge_commit: Literal["a0a21c648e881c7eb733967b42ee6f08cbcbb48a"]
    ...
    operator_attestation_required: Literal[True]
    v5_implementation_validation_required_at_issue: Literal[True]
    semantic_boundary_revalidated_at_issue: Literal[True]
...
class ExecutionAuthorization(FrozenModel):
    ...
    implementation_feature_commit: Literal["7760ee785ec11d6c85d8d2d2d2a20b59a2ef9e23"]
    implementation_merge_commit: Literal["a0a21c648e881c7eb733967b42ee6f08cbcbb48a"]
    notebook_sha256: Literal["76fcefea77505180aca1fdfd89179a1a81c49fd754507aacd17277caf012f2ea"]
    ...
    v5_implementation_validated: Literal[True]
    semantic_channel_contract_validated: Literal[True]
    ...
    next_gate: Literal["execute_one_governed_final_offline_verifier_v5_saved_version"]
...
class TerminalOutcome(StrEnum):
    """Terminal execution-attempt outcome."""
...
class AuthorizationConsumption(FrozenModel):
    ...
    def require_terminal_evidence(self) -> Self:
        ...
        if self.evidence_zip_sha256 is not None:
            if not _is_sha256(self.evidence_zip_sha256):
                raise ValueError("evidence ZIP SHA-256 is invalid")
        return self


class AuthorizationAbandonment(FrozenModel):
    ...
    pilot_execution_authorized: Literal[False]
    final_measured_abc_execution_authorized: Literal[False]
    next_gate: Literal["reconcile_then_issue_fresh_final_offline_verifier_v5_authorization"]
...
def _identity(
    ...
    if not target.is_file() or target.is_symlink():
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTH_ISSUER_ARTIFACT_MISSING",
...
def _require_bound_implementation(
    repo_root: Path,
    ...
    if returncode != 0:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTH_ISSUER_IMPLEMENTATION_NOT_ANCESTOR",
            "bound V5 implementation merge commit is not an ancestor of HEAD",
        )

    identities: list[ArtifactIdentity] = []
    for path_text, expected in V5_ARTIFACT_IDENTITIES.items():
        ...
        if identity.sha256 != expected_sha or identity.size_bytes != expected_size:
            _raise(
                "FINAL_OFFLINE_VERIFIER_V5_AUTH_ISSUER_IMPLEMENTATION_DRIFT",
                "bound V5 implementation artifact identity drifted",
                path,
                (
...
def build_record(repo_root: Path) -> IssuerRecord:
    """Build deterministic non-live issuer record."""
    ...
    return IssuerRecord(
        ...
        status=("FINAL_OFFLINE_VERIFIER_V5_EXECUTION_AUTHORIZATION_ISSUER_VALID"),
        ...
        v5_implementation_validation_required_at_issue=True,
        semantic_boundary_revalidated_at_issue=True,
...
def generate_record(repo_root: Path) -> dict[str, object]:
    """Generate deterministic repository issuer record."""
    ...
    return {
        ...
        "runtime_execution_authorized": False,
        "next_kaggle_execution_authorized": False,
        "next_gate": "merge_authorization_issuer_then_attest_and_issue",
    }
...
def validate_implementation(
    ...
    """Validate canonical issuer implementation."""
    ...
    if not target.is_file() or target.is_symlink():
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTH_ISSUER_RECORD_MISSING",
            "issuer record is missing or invalid",
            ISSUER_RECORD_PATH,
        )
    if target.read_bytes() != expected_bytes:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTH_ISSUER_RECORD_DRIFT",
...
def _require_no_lifecycle_artifact(
    repo_root: Path,
) -> None:
    present = tuple(
        path.as_posix()
    ...
    if present:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_LIFECYCLE_ALREADY_STARTED",
            "a live or terminal V5 authorization artifact already exists",
            details=present,
        )


def _require_issue_repo_state(
    repo_root: Path,
    issuer_merge_commit: str,
) -> None:
    branch = _require_git_success(
        repo_root,
        "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_GIT_STATE_FAILED",
    ...
    if branch != "main":
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_NOT_ON_MAIN",
    ...
    if head != issuer_merge_commit:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_ISSUER_COMMIT_MISMATCH",
            "confirmed issuer merge commit does not equal HEAD",
        )
    if head != origin_main:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_MAIN_NOT_SYNCHRONIZED",
    ...
    if status:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_REPOSITORY_NOT_CLEAN",
    ...
    if returncode != 0:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_IMPLEMENTATION_NOT_ANCESTOR",
            "bound V5 implementation is not contained by issuer main",
        )


def _run_v5_validation(
    repo_root: Path,
) -> dict[str, object]:
    result = subprocess.run(
        [
    ...
    if result.returncode != 0:
        ...
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_PREEXECUTION_FAILED",
            "V5 implementation validation failed before authorization",
            details=details,
        )
    ...
    try:
        ...
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_PREEXECUTION_FAILED",
            "V5 implementation validator returned invalid JSON",
            details=(str(error),),
        )
    if not isinstance(payload, dict):
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_PREEXECUTION_FAILED",
            "V5 implementation validator did not return an object",
        )
    return payload


def _require_v5_preexecution_contract(
    repo_root: Path,
) -> None:
    payload = _run_v5_validation(repo_root)
    ...
    if drift:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_PREEXECUTION_DRIFT",
            "V5 pre-execution implementation contract drifted",
            details=drift,
        )
...
def issue_authorization(
    ...
    *,
    ...
    """Issue one short-lived V5 execution authorization."""

    validate_implementation(repo_root)
    _require_v5_preexecution_contract(repo_root)
    ...
    authorization = ExecutionAuthorization(
        ...
        notebook_sha256=V5_ARTIFACT_IDENTITIES[
            ("notebooks/auragateway_preflight_v3_exact_runtime_offline_compatibility_v5.ipynb")
        ][0],
        operator_confirmation=CONFIRMATION_PHRASE,
        operator_attested_platform="T4_X2",
        operator_attested_gpu_count=2,
        operator_attested_internet_enabled=False,
        execution_limits=ExecutionLimits(),
        expected_evidence_members=EXPECTED_OUTPUT_MEMBERS,
        expected_evidence_zip=EXPECTED_EVIDENCE_ZIP,
        preserve_saved_version=True,
        v5_implementation_validated=True,
        semantic_channel_contract_validated=True,
        offline_verifier_v5_execution_authorized=True,
...
def _read_authorization(
    ...
    if not target.is_file() or target.is_symlink():
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_MISSING",
            "live V5 authorization file is missing",
            AUTHORIZATION_PATH,
        )
    ...
    try:
        ...
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_INVALID",
            "live V5 authorization file is invalid",
            AUTHORIZATION_PATH,
            (str(error),),
        )
    ...
    if payload != canonical:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_NONCANONICAL",
            "live V5 authorization bytes are not canonical",
            AUTHORIZATION_PATH,
        )
...
def validate_live_authorization(
    ...
    *,
    ...
    """Validate current live authority without mutating it."""
    ...
    if (repo_root / CONSUMPTION_PATH).exists() or (repo_root / ABANDONMENT_PATH).exists():
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_ALREADY_TERMINAL",
    ...
    if observed_now >= authorization.expires_at:
        _raise(
            "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_EXPIRED",
...
def consume_authorization(
    ...
    *,
    ...
    target.write_bytes(_canonical_json_bytes(receipt.model_dump(mode="json")))
    return receipt
...
def abandon_authorization(
    ...
    *,
    ...
    """Close unused live authority without execution."""
...
def _print_error(
    error: AuthorizationIssuerError,
) -> None:
    ...
    try:
        if args.command == "generate-record":
            ...
            if args.issuer_merge_commit is None:
                _raise(
                    "FINAL_OFFLINE_VERIFIER_V5_AUTHORIZATION_ARGUMENT_MISSING",
