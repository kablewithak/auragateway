...
def _validate_launcher(
    ...
    *,
    ...
    historical_source_commit: str = SOURCE_COMMIT
    if launcher_source_commit != historical_source_commit:
        raise HarnessEvidenceIntegrationError(
    ...
    launcher_harness_source_path: str = launcher.HARNESS_SOURCE_PATH
    historical_harness_mounted_path: str = CURRENT_HARNESS_MOUNTED_PATH
    if launcher_harness_source_path != historical_harness_mounted_path:
        raise HarnessEvidenceIntegrationError(
