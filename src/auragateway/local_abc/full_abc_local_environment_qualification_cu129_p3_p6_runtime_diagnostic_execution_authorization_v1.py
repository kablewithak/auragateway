...
from auragateway.local_abc import (
    full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v1,
)
from auragateway.local_abc.contracts import LocalABCContract

implementation = full_abc_local_environment_qualification_cu129_p3_p6_runtime_diagnostic_v1

SOURCE_MAIN_MERGE_COMMIT: Final = "d0ef674128479f191149e12987a7f952d82c2782"
IMPLEMENTATION_FEATURE_COMMIT: Final = "603b412f6f4c511bbf6e18d5e08d7a480986743e"
...
IMPLEMENTATION_REQUEST_SHA256: Final = (
    "5aa4eb0851e3b1ac3e5bd875c6e33016c9c95da49daf3c5fa4cce5a26b8e007b"
)
IMPLEMENTATION_REVIEW_SHA256: Final = (
    "b31ad41ad7ddec20caabe811f88688bd14bec1b3dacd0d7b753fb9fb6cc75f0b"
)
IMPLEMENTATION_TEMPLATE_SHA256: Final = (
    "1ff3d6751fb6f097720a6067877e177ccdf4e04a71dc545248a712a1e91c24ac"
)
IMPLEMENTATION_SOURCE_SHA256: Final = (
    "0a15c42d372bc42ebe4e4bf1ec86f1f17ade34f59b74ddc039d5a9a1440da2a1"
)
...
IMPLEMENTATION_SOURCE_PATH: Final = Path(
    ...
    "p3_p6_runtime_diagnostic_v1.py"
)

ISSUER_SOURCE_PATH: Final = Path(
    "src/auragateway/local_abc/"
    "full_abc_local_environment_qualification_cu129_"
    "p3_p6_runtime_diagnostic_execution_authorization_v1.py"
)
...
ADR_PATH: Final = Path(
    "docs/adr/2026-07-31-local-abc-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1.md"
)
REPORT_PATH: Final = Path(
    "docs/reports/AuraGateway_CU129_P3_P6_Runtime_Diagnostic_Execution_Authorization_V1.md"
)
RUNBOOK_PATH: Final = Path(
    "docs/runbooks/local_abc_cu129_p3_p6_runtime_diagnostic_execution_authorization_v1.md"
)
...
AUTHORIZATION_SCOPE: Final = "P3_P6_RUNTIME_DIAGNOSTIC_V1"
SELECTED_BACKEND: Final = "TRITON_ATTN"
MAXIMUM_AUTHORIZATION_WINDOW_MINUTES: Final = 240
IMPLEMENTATION_NEXT_GATE: Final = (
    "explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v1"
)
ISSUED_NEXT_GATE: Final = "execute_governed_p3_p6_runtime_diagnostic_v1"
CONSUMED_NEXT_GATE: Final = "preserve_and_accept_p3_p6_runtime_diagnostic_evidence_v1"
...
class ImplementationAuthority(LocalABCContract):
    ...
    source_main_merge_commit: Literal["d0ef674128479f191149e12987a7f952d82c2782"]
    implementation_feature_commit: Literal["603b412f6f4c511bbf6e18d5e08d7a480986743e"]
    ...
    unchanged_q6_replay_authorized: Literal[False]
...
class AuthorizationArchitectureReview(LocalABCContract):
    ...
    review_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1-review"
    ]
    status: Literal["APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION"]
    decision: Literal["SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_AUTHORIZATION"]
    ...
    next_gate: Literal["explicit_operator_confirmation_then_issue_p3_p6_execution_authorization_v1"]
...
class AuthorizationImplementationRecord(LocalABCContract):
    ...
    schema_version: Literal["1.0.0"] = "1.0.0"
    record_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1-record"
    ]
    status: Literal["P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V1_VALID"]
...
class AuthorizationIssuanceConfirmation(LocalABCContract):
    ...
    confirmation_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-confirmation-v1"
    ]
    operator_confirmed: Literal[True]
    confirmed_at: datetime
    authorization_window_minutes: int = Field(ge=1, le=240)
    confirmed_scope: Literal["P3_P6_RUNTIME_DIAGNOSTIC_V1"]
...
class P3P6ExecutionAuthorization(LocalABCContract):
    ...
    request_sha256: Literal["5aa4eb0851e3b1ac3e5bd875c6e33016c9c95da49daf3c5fa4cce5a26b8e007b"]
...
class P3P6AuthorizationConsumption(LocalABCContract):
    ...
    consumption_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-consumption-v1"
    ]
    authorization_id: Literal[
        "auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1"
    ]
...
def _implementation_authority(repo_root: Path) -> ImplementationAuthority:
    ...
    return ImplementationAuthority(
        ...
        unchanged_q6_replay_authorized=False,
    )


def _build_review(repo_root: Path) -> AuthorizationArchitectureReview:
    return AuthorizationArchitectureReview(
        review_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1-review"),
        status="APPROVED_FOR_AUTHORIZATION_IMPLEMENTATION",
        decision="SEPARATE_TRANSIENT_SINGLE_USE_P3_P6_AUTHORIZATION",
...
def _build_record(
    ...
    return AuthorizationImplementationRecord(
        record_id=("auragateway-cu129-p3-p6-runtime-diagnostic-execution-authorization-v1-record"),
        status="P3_P6_RUNTIME_DIAGNOSTIC_EXECUTION_AUTHORIZATION_V1_VALID",
        source_main_merge_commit=SOURCE_MAIN_MERGE_COMMIT,
        implementation=_implementation_authority(repo_root),
        review=ArtifactReceipt(
...
def _build_parser() -> argparse.ArgumentParser:
    parser = _ArgumentParser(prog="auragateway-p3-p6-authorization-v1")
