...
_V6_AUTHORIZATION_ID = "live-development-batch-06-auth-v1"
_PACED_AUTHORIZATION_IDS = frozenset(
    {
        ...
        _V6_AUTHORIZATION_ID,
    }
)
_DIAGNOSTIC_AUTHORIZATION_IDS = frozenset(
    {_V4_AUTHORIZATION_ID, _V5_AUTHORIZATION_ID, _V6_AUTHORIZATION_ID}
)
_BATCH_ASSET_ROOTS = {
    ...
    _V6_AUTHORIZATION_ID: Path("data/evals/benchmark/live-development-v6"),
}
